...
{
	protected static $table_name="text";
	protected static $db_fields=array('id','page_id','title','text','image_title','entrytime');
	...
	private $temp_path;
	protected $upload_dir="/home/content/a/n/d/andrewtdunn28/html/_images/page_images";
	public $errors=array();
