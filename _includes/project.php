...
class Project extends DatabaseObject
{
	...
	protected static $db_fields=array('id','title','text','image_title','vimeoID','overlay_text','entrytime');
	...
	private $temp_path;
	protected $upload_dir="/home/content/a/n/d/andrewtdunn28/html/_images/project_images";
	public $errors=array();
	...
	public function image_path()
	{
		...
		//return "../_images/project_images".DS.$this->image_title;
	}
